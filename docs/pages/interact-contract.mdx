...
We then import the `data.json` file and will use the `e` and `d` utilities from `xsuite/data` to encode/decode data respectively to a format that the MultiversX blockchain understands. More info on the [Data Encoding](/data-encoding) page
