...
test("LSWorld.createWallet - with shard", async () => {
  using world = await startWorld();
...
test("LSWorld.createContract - with shard", async () => {
  using world = await startWorld();
